...
class Student(models.Model):
    ...
    S_number = models.CharField(max_length=11, unique=True, validators=[MinLengthValidator(11)])
...
class Teacher(models.Model):
    ...
    T_number = models.CharField(max_length=11, unique=True, validators=[MinLengthValidator(11)])
...
class Course(models.Model):
    ...
    T_id = models.ForeignKey(Teacher, to_field='T_number', on_delete=models.CASCADE)
